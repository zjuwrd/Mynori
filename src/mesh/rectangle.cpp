...
public:
    Rectangle(const PropertyList& props){
        ...
        if(!inverse_normal)
        {
            ...
            if(two_sided)
            {
                m_F.col(2) = Vector3i( uint32_t(2),uint32_t(1),uint32_t(0)).cast<uint32_t>();
                m_F.col(3) = Vector3i( uint32_t(2),uint32_t(0),uint32_t(3)).cast<uint32_t>();
            }
            ...
            if(two_sided)
            {
                m_F.col(2) = Vector3i( uint32_t(0),uint32_t(1),uint32_t(2)).cast<uint32_t>();
                m_F.col(3) = Vector3i(uint32_t(3),uint32_t(0),uint32_t(2)).cast<uint32_t>();
            }
