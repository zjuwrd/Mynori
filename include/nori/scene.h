...
public:
    /// @brief Sample direct radiance from the scene. Note that the function itself can take into consider the material of the intersected mesh(delta or diffuse)
    /// @param ray ray generated by PathTracing
    /// @param its intersect point by ray on the scene
    /// @param sampler uniform sampler
    /// @return the direct radiance from the scene
